...
class NPC(AnimatedSprite):
    ...
    def ray_cast_player_npc(self):
        ...
        if 0 < player_dist < wall_dist_h or not wall_dist:
            return True
        return False
...
class SattyDaddyNPC(NPC):
    def __init__(self, game, path='resources/sprites/npc/SATTY_DADDY/0.png', pos=(9.5, 5.5),
                 scale=0.5, shift=0.04, animation_time=210):
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 8
        self.health = 500
        self.attack_damage = 25
